...
const Chatbox = (props) => {
    ...
    const userMsgUrl = "hhttps://notfacebook-b2511391168d.herokuapp.com/user-message";
    const groupMsgUrl = "hhttps://notfacebook-b2511391168d.herokuapp.com/group-message";
