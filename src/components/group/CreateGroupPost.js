...
function  CreateGroupPost(props) {
    ...
    function SubmitHandler(event) {
        ...
        // fetch('https://cors-anywhere.herokuapp.com/https://notfacebook-b2511391168d.herokuapp.com/group-post',
        // {
        //     method: 'POST',
        //     credentials: "include",
        //     mode: "cors",
        ...
        //     if (data.success) {
        //         // render all posts
        //         fetch(`https://cors-anywhere.herokuapp.com/https://notfacebook-b2511391168d.herokuapp.com/group-post?groupid=${props.groupid}`)
        //         .then(resp => {
        //             return resp.json();
        //         })
        //         .then(data => {
