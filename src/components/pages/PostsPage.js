...
const PostsPage = () => {
    ...
    // const postUrl = "https://cors-anywhere.herokuapp.com/https://notfacebook-b2511391168d.herokuapp.com/post";
    const postCommentUrl = "https://cors-anywhere.herokuapp.com/https://notfacebook-b2511391168d.herokuapp.com/post-comment";
    ...
    console.log(userId)
    useEffect(() => {
        fetch(`https://cors-anywhere.herokuapp.com/https://notfacebook-b2511391168d.herokuapp.com/post?id=${userId}`)
            .then(resp => resp.json())
            .then(data => {
    ...
    const createPostHandler = useCallback((createPostPayloadObj) => {
        ...
        fetch(`https://cors-anywhere.herokuapp.com/https://notfacebook-b2511391168d.herokuapp.com/post`, reqOptions)
            .then(resp => resp.json())
            .then(data => {
