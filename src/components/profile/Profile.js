...
function Profile({ userId }) {
    ...
    const storeFollow = (targetId) => {
        ...
        fetch('hhttps://notfacebook-b2511391168d.herokuapp.com/user-follower', reqOptions)
            .then(resp => resp.json())
            .then(data => {
    ...
    const setPublicityHandler = (e) => {
        ...
        fetch('hhttps://notfacebook-b2511391168d.herokuapp.com/privacy',
            {
                method: 'POST',
                credentials: "include",
                mode: 'cors',
    ...
    useEffect(() => {
        fetch(`hhttps://notfacebook-b2511391168d.herokuapp.com/user-follow-status?tid=${userId}&sid=${currUserId}`)
    ...
    //Get followers
    useEffect(() => {
        fetch(`hhttps://notfacebook-b2511391168d.herokuapp.com/user-follower?id=${userId}`)
            .then(resp => resp.json())
            .then(data => {
    ...
    //Get following
    useEffect(() => {
        fetch(`hhttps://notfacebook-b2511391168d.herokuapp.com/user-following?id=${userId}`)
            .then(resp => resp.json())
            .then(data => {
    ...
    function closeFriendHandler(e) {
        ...
        fetch('hhttps://notfacebook-b2511391168d.herokuapp.com/close-friend', cfOptions)
            .then(resp => resp.json())
            .then(data => {
                console.log("closefriend event: ", data);
                if (data.success) {
