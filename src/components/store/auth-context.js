...
export const AuthContextProvider = (props) => {
	...
	const loginURL =
		"http://https://notfacebook-b2511391168d.herokuapp.com/login";
	const regURL = "http://https://notfacebook-b2511391168d.herokuapp.com/reg";
	const logoutURL =
		"http://https://notfacebook-b2511391168d.herokuapp.com/logout";
			...
			fetch(loginURL, reqOptions)
				...
				.then((data) => {
					...
					if (data.resp.success) {
						...
						data.resp.avatar &&
							localStorage.setItem("avatar", data.resp.avatar);
						...
						data.notif &&
							localStorage.setItem(
								"new_notif",
								JSON.stringify(Object.values(data.notif))
							);
						...
						throw new Error(
							"Login Failed: Please check your credentials and login again"
						);
					}
