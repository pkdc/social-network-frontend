...
export const FollowingContextProvider = (props) => {
    ...
    const followingUrl = `hhttps://notfacebook-b2511391168d.herokuapp.com/user-following?id=${selfId}`;
    ...
    const getPrivateChatHandler = () => {
        ...
        fetch(`hhttps://notfacebook-b2511391168d.herokuapp.com/private-chat-item?id=${selfId}`)
        .then(resp => resp.json())
        .then(data => {
