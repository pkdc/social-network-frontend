...
export const FollowingContextProvider = (props) => {
    ...
    const followingUrl = `https://cors-anywhere.herokuapp.com/https://notfacebook-b2511391168d.herokuapp.com/user-following?id=${selfId}`;
    ...
    const getPrivateChatHandler = () => {
        ...
        fetch(`https://cors-anywhere.herokuapp.com/https://notfacebook-b2511391168d.herokuapp.com/private-chat-item?id=${selfId}`)
        .then(resp => resp.json())
        .then(data => {
