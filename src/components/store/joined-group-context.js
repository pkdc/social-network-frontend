...
export const JoinedGroupContextProvider = (props) => {
    ...
    const joinedGroupingUrl = `hhttps://notfacebook-b2511391168d.herokuapp.com/group-member?userid=${selfId}`;
    const requestedGroupUrl = `hhttps://notfacebook-b2511391168d.herokuapp.com/group-request-by-user?id=${selfId}`;
        ...
        (async function() {
            try {
                const promises = [
                    ...
                    fetchGroupChatData(`hhttps://notfacebook-b2511391168d.herokuapp.com/group-chat-item?userid=${selfId}`),
                ];
